...
namespace OriginaWebApp.Models.Formatos
{
    public class fmtfmtTablaAmortizacion
    {
        ...
        public string FormatoHTML(InputData data)
        {
            ...
            strDocumento += @"                <img align=""left"" src=""Img\APR_Firma_Hor_Fblanco_RGB.png"" width=""140"" height=""80"" />              ";
            strDocumento += @"                <br>                                                                                                      ";
            strDocumento += @"            </td>                                                                                                         ";
            strDocumento += @"            <td>                                                                                                          ";
            strDocumento += @"                <p class=""b""><b>Fecha de Otorgamiento:<br>Fecha de Vencimiento:</b></p>                                 ";
            strDocumento += @"            </td>                                                                                                         ";
            strDocumento += @"            <td><p>@Model.FechadeOtorgamiento<br>@Model.FechadeVencimiento</p></td>                                       ";
            strDocumento += @"        </tr>                                                                                                             ";
            strDocumento += @"    </table>                                                                                                              ";
            strDocumento += @"    <table>                                                                                                               ";
            strDocumento += @"        <tr>                                                                                                              ";
            strDocumento += @"            <td width=""200px""><b>No de Pagare</b></td>                                                                  ";
            strDocumento += @"            <td>@Model.NodePagare</td>                                                                                    ";
            strDocumento += @"        </tr>                                                                                                             ";
            strDocumento += @"        <tr>                                                                                                              ";
            strDocumento += @"            <td><b>Monto de Renovación:</b></td>                                                                          ";
            strDocumento += @"            <td>$ @Model.MontodeRenovación</td>                                                                           ";
            strDocumento += @"        </tr>                                                                                                             ";
            strDocumento += @"        <tr>                                                                                                              ";
            strDocumento += @"            <td><b>Tipo de Crédito:</b></td>                                                                              ";
            strDocumento += @"            <td>                                                                                                          ";
            strDocumento += @"                <p class=""b"">                                                                                           ";
            strDocumento += @"                    @Model.TipodeCredito                                                                                  ";
            strDocumento += @"<p>                                                                                                                       ";
            strDocumento += @"            </td>                                                                                                         ";
            strDocumento += @"        </tr>                                                                                                             ";
            strDocumento += @"    </table>                                                                                                              ";
            ...
            strDocumento += @"            <td>@Model.NombreCliente</td>                                                                                 ";
            strDocumento += @"        </tr>                                                                                                             ";
            strDocumento += @"        <tr>                                                                                                              ";
            strDocumento += @"            <td width=""100px""><b>Domicilio:</b></td>                                                                    ";
            strDocumento += @"            <td>@Model.Domicilio</td>                                                                                     ";
            strDocumento += @"        </tr>                                                                                                             ";
            strDocumento += @"        <tr>                                                                                                              ";
            strDocumento += @"            <td><b>Colonia:</b></td>                                                                                      ";
            strDocumento += @"            <td>@Model.Colonia</td>                                                                                       ";
            strDocumento += @"        </tr>                                                                                                             ";
            strDocumento += @"        <tr>                                                                                                              ";
            strDocumento += @"            <td><b>Ciudad:</b></td>                                                                                       ";
            strDocumento += @"            <td>@Model.Ciudad</td>                                                                                        ";
            strDocumento += @"        </tr>                                                                                                             ";
            strDocumento += @"        <tr>                                                                                                              ";
            strDocumento += @"            <td><b>Telefono:</b></td>                                                                                     ";
            strDocumento += @"            <td>@Model.Telefono</td>                                                                                      ";
            strDocumento += @"        </tr>                                                                                                             ";
            strDocumento += @"    </table>                                                                                                              ";
            ...
            strDocumento += @"            </tr>                                                                                                         ";
            strDocumento += @"                                                                                                                          ";
            strDocumento += @"                @foreach (var item in @Model.listTamortizacion)                                                           ";
            strDocumento += @"                {                                                                                                         ";
            strDocumento += @"        <tr>                                                                                                              ";
            strDocumento += @"            <td>                                                                                                          ";
            ...
            strDocumento += @"        <p class=""b"">                                                                                                   ";
            strDocumento += @"            <b>                                                                                                           ";
            strDocumento += @"                @Model.NombreCliente                                                                                      ";
            strDocumento += @"            </b>                                                                                                          ";
            strDocumento += @"        </p>                                                                                                              ";
            strDocumento += @"        <p class=""b"">                                                                                                   ";
