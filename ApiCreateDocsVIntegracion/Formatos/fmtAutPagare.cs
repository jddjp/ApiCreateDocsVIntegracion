...
namespace OriginaWebApp.Models.Formatos
{
    public class fmtfmtPagare
    {
        ...
        public string FormatoHTML(InputData data)
        {
           ...
           strDocumento = @"@model ApiCreacionDocs.Models.InformacionDocs.InputPagare;																					";
            ...
            strDocumento += @"    <p align=""left"">NÚMERO DE CONTRATO: <U><b>@Model.NumeroContrato</b></U></p>                                                            ";
            strDocumento += @"    <p style=""margin:0;display:inline;float:left"">NUMERO DE PAGARE: <u><b>@Model.NumeroPagare</b></u></p>                                  ";
            strDocumento += @"    <p style=""margin:0;display:inline;float:right"">BUENO POR $ <U><b>@Model.Cantidadpagare</b></U></p>                                     ";
            strDocumento += @"    <br />                                                                                                                                   ";
            ...
            strDocumento += @"            <u><b>PUEBLA PUEBLA MEXICO</b></u>. Y/O EN SU DOMICILIO UBICADO EN: <u><b>@Model.DireccionEmite</b></u> COLONIA                  ";
            strDocumento += @"            <u><b>@Model.ColoniaEmite</b></u> DE LA CIUDAD DE <u><b>@Model.CiudadEmite,@Model.PaisEmite</b></u>                              ";
            strDocumento += @"			LA CANTIDAD EN EFECTIVO DE <u>                                                                                                     ";
            strDocumento += @"                <b>                                                                                                                          ";
            strDocumento += @"                    @Model.CantidadpagareNumLetras                                                                                           ";
            strDocumento += @"                </b>                                                                                                                         ";
            strDocumento += @"            </u>LO CUAL HARE MEDIANTE <u><b>@Model.NumAmortizaciones</b></u> PAGOS                                                           ";
            strDocumento += @"            <u><b>@Model.PagosPeridicidad</b></u> Y CONSECUTIVOS, CADA UNO DE ELLOS POR LA CANTIDAD DE                                       ";
            strDocumento += @"            <u>                                                                                                                              ";
            strDocumento += @"                <b>                                                                                                                          ";
            strDocumento += @"                    @Model.CantidadPagosnumeroyletras                                                                                        ";
            strDocumento += @"                </b>                                                                                                                         ";
            strDocumento += @"            </u>                                                                                                                             ";
            strDocumento += @"            INICIANDO EL PRIMER PAGO, A PARTIR DEL DIA <u><b>@Model.DiaPrimerPago</b></u> DEL MES DE <u>                                     ";
            strDocumento += @"			<b>@Model.MesPrimerPago</b></u> DEL AÑO <u><b>@Model.AnioPrimerpago</b></u> Y VENCIENDO EL                                         ";
            strDocumento += @"            ULTIMO PAGO EL DÍA <u><b>@Model.DiaUltimoPago</b></u> DEL MES DE <u><b>@Model.MesUltimoPago</b></u>                              ";
            strDocumento += @"			DEL AÑO <u><b>@Model.AnioUltimoPago</b></u>.                                                                                       ";
            strDocumento += @"        </font>                                                                                                                              ";
            strDocumento += @"    </p>                                                                                                                                     ";
            strDocumento += @"    <p class=""b"">                                                                                                                          ";
            ...
            strDocumento += @"        DEL <u><b>@Model.TasaOrdinaria</b></u> POR CIENTO ANUAL, POR CADA MES O FRACCIÓN, LOS CUALES DEBERÉ PAGAR                            ";
            ...
            strDocumento += @"        SERÁN CALCULADOS A UNA TASA DE INTERÉS MORATORIO DEL <u><b>@Model.TasaMoratoria</b></u> POR CIENTO MENSUAL, POR                      ";
            ...
            strDocumento += @"        DE <u><b>@Model.CiudadEmite</b></u> RENUNCIANDO EL SUSCRIPTOR Y SU AVAL SI LO HUBIERE, A CUALQUIER OTRO DOMICILIO O                  ";
            strDocumento += @"        FUERO QUE PUDIERE CORRESPONDERLES POR RAZÓN DE SUS DOMICILIOS PRESENTES O FUTUROS.                                                   ";
            strDocumento += @"    </p>                                                                                                                                     ";
            strDocumento += @"    <br />                                                                                                                                   ";
            strDocumento += @"    <p class=""b""> EL PRESENTE PAGARE SE SUSCRIBE EN LA CIUDAD DE <u><b>@Model.PersonaCiudad</b></u>,                                       ";
            ...
            strDocumento += @"        NOMBRE: <U><b>@Model.PersonaNombre</b></U><br />                                                                                     ";
            strDocumento += @"        DOMICILIO:<U><b>@Model.PersonaDomicilio</b></U><br />                                                                                ";
            strDocumento += @"        COLONIA O FRACCIONAMIENTO:<U><b>@Model.PersonaColonia</b></U><br />                                                                  ";
            strDocumento += @"        CIUDAD:<U><b>@Model.PersonaCiudad</b></U><br />                                                                                      ";
            strDocumento += @"        TELÉFONO(S):<U><b>@Model.PersonaTelefono</b></U> Y <U><b>@Model.PersonaTelefono</b></U>                                              ";
            strDocumento += @"    <p />                                                                                                                                    ";
            strDocumento += @"</body>                                                                                                                                      ";
            strDocumento += @"</html>";
