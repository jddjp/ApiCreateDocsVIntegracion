...
{
    public class fmtAutFooterArticulosLegalesConsumo
    {
        ...
        public string FormatoHTML(InputData data,string logo)
        {
            ...
            strDocumento += "                                                                                                                                                         ";
            strDocumento += "                                                                                                                                                                  ";
            strDocumento += "          <b>  <p align='center' class='b'>REGISTRO DE CONTRATOS DE ADHESIÓN NÚMERO: 2028-440-004742/17-00217-0121 </p> </b>                                                                                                                                                                          ";
            strDocumento += "                                                                                                                                                                           ";
            strDocumento += "                                                                                                                                                                     ";
            strDocumento += "                                                                                                                                                                               ";
            strDocumento += "                                                                                                                                                                               ";
